...
the goal is to learn from each other by producing many visualizations on a common data set. we'll often identify interesting patterns; more importantly, we get to quickly compare design choices, statistical methods, tool choices, failures and successes. \n\n\
